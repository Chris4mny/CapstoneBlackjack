...
{
    public class Gameplay : TheCards
    {
        ...
        private char player1UnicodeSuit;
        private String player2FaceValue;
        private char player2UnicodeSuit;
        private String dealerFaceValue;
        private char dealerUnicodeSuit;
        ...
        private void decisionToContinuePlayingBlackjackTwoPlayer()
        {
            InputOutput IO = new InputOutput();
        ...
        private void checkForAcePlayer2(int getAnotherCard)
        {
            while (true)
            {
        ...
        private void checkForAcePlayer1(int getAnotherCard)
        {
            while (true)
            {
